...
Portfolio allocation will be calculated at open for this increase/decrease. EMA comparison uses closing data from completed day t. The resulting order executes at the opening price on day t + 1.
